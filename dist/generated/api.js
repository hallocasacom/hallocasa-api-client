...
exports.CourseFormatEnum = {
    Online: 'ONLINE',
    InPerson: 'IN_PERSON',
    Hybrid: 'HYBRID'
};
exports.CourseDesignationEnum = {
    Abr: 'ABR',
    Cips: 'CIPS',
    Cpm: 'CPM',
    Crb: 'CRB',
...
exports.CourseWriteDtoFormatEnum = {
    Online: 'ONLINE',
    InPerson: 'IN_PERSON',
    Hybrid: 'HYBRID'
};
exports.CourseWriteDtoDesignationEnum = {
    Abr: 'ABR',
    Cips: 'CIPS',
    Cpm: 'CPM',
    Crb: 'CRB',
...
exports.PropertyPublicationStateRequestStatusEnum = {
    Available: 'AVAILABLE',
    Rented: 'RENTED',
    Sold: 'SOLD',
    Draft: 'DRAFT'
...
exports.UserPlatformInviteRequestSourceEnum = {
    Header: 'HEADER',
    ProfileInviteFriend: 'PROFILE_INVITE_FRIEND',
    NetworkGrowthPopup: 'NETWORK_GROWTH_POPUP',
    Unknown: 'UNKNOWN'
};
...
const CoursesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        _delete: async (courseId, options = {}) => {
            // verify required parameter 'courseId' is not null or undefined
            (0, common_1.assertParamExists)('_delete', 'courseId', courseId);
         ...
         * @throws {RequiredError}
         */
        attendGo1: async (courseId, source, options = {}) => {
            // verify required parameter 'courseId' is not null or undefined
            (0, common_1.assertParamExists)('attendGo1', 'courseId', courseId);
         ...
         * @throws {RequiredError}
         */
        create1: async (userId, courseWriteDto, options = {}) => {
            // verify required parameter 'userId' is not null or undefined
            (0, common_1.assertParamExists)('create1', 'userId', userId);
            // verify required parameter 'courseWriteDto' is not null or undefined
            (0, common_1.assertParamExists)('create1', 'courseWriteDto', courseWriteDto);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers };
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(courseWriteDto, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        get1: async (courseId, options = {}) => {
            // verify required parameter 'courseId' is not null or undefined
            (0, common_1.assertParamExists)('get1', 'courseId', courseId);
            const localVarPath = `/courses/{courseId}`
                .replace(`{${"courseId"}}`, encodeURIComponent(String(courseId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        getBySlug1: async (slug, options = {}) => {
            // verify required parameter 'slug' is not null or undefined
            (0, common_1.assertParamExists)('getBySlug1', 'slug', slug);
         ...
         * @throws {RequiredError}
         */
        list1: async (pageFrom, pageTo, language, format, designation, ceCreditsOnly, createdInLastDays, happeningInNextDays, options = {}) => {
         ...
         * @throws {RequiredError}
         */
        listForUser1: async (userId, pageFrom, pageTo, options = {}) => {
            // verify required parameter 'userId' is not null or undefined
            (0, common_1.assertParamExists)('listForUser1', 'userId', userId);
            const localVarPath = `/users/{userId}/courses`
                .replace(`{${"userId"}}`, encodeURIComponent(String(userId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        recordAnonymousClick1: async (courseId, eventType, source, options = {}) => {
            // verify required parameter 'courseId' is not null or undefined
            (0, common_1.assertParamExists)('recordAnonymousClick1', 'courseId', courseId);
            // verify required parameter 'eventType' is not null or undefined
            (0, common_1.assertParamExists)('recordAnonymousClick1', 'eventType', eventType);
         ...
         * @throws {RequiredError}
         */
        update1: async (courseId, courseWriteDto, options = {}) => {
            // verify required parameter 'courseId' is not null or undefined
            (0, common_1.assertParamExists)('update1', 'courseId', courseId);
            // verify required parameter 'courseWriteDto' is not null or undefined
            (0, common_1.assertParamExists)('update1', 'courseWriteDto', courseWriteDto);
            const localVarPath = `/courses/{courseId}`
                .replace(`{${"courseId"}}`, encodeURIComponent(String(courseId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
...
const CoursesApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async _delete(courseId, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator._delete(courseId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['CoursesApi._delete']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        async attendGo1(courseId, source, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.attendGo1(courseId, source, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['CoursesApi.attendGo1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        async create1(userId, courseWriteDto, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.create1(userId, courseWriteDto, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['CoursesApi.create1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        async get1(courseId, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.get1(courseId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['CoursesApi.get1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Globally visible active course matched by slug
         ...
         * @throws {RequiredError}
         */
        async getBySlug1(slug, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getBySlug1(slug, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['CoursesApi.getBySlug1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Globally visible active courses. When createdInLastDays or happeningInNextDays is set, returns the same set as the matching instructor Ortto job (UTC windows); other filters and pagination are ignored for those modes.
         ...
         * @throws {RequiredError}
         */
        async list1(pageFrom, pageTo, language, format, designation, ceCreditsOnly, createdInLastDays, happeningInNextDays, options) {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['CoursesApi.list1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        async listForUser1(userId, pageFrom, pageTo, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listForUser1(userId, pageFrom, pageTo, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['CoursesApi.listForUser1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        async recordAnonymousClick1(courseId, eventType, source, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.recordAnonymousClick1(courseId, eventType, source, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['CoursesApi.recordAnonymousClick1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        async update1(courseId, courseWriteDto, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.update1(courseId, courseWriteDto, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['CoursesApi.update1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    };
};
...
const CoursesApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        attendGo1(requestParameters, options) {
         ...
         * @throws {RequiredError}
         */
        getBySlug1(requestParameters, options) {
         ...
         * @throws {RequiredError}
         */
        listForUser1(requestParameters, options) {
         ...
         * @throws {RequiredError}
         */
        recordAnonymousClick1(requestParameters, options) {
...
class CoursesApi extends base_1.BaseAPI {
     ...
     */
    _delete(requestParameters, options) {
        return (0, exports.CoursesApiFp)(this.configuration)._delete(requestParameters.courseId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Track attend click and redirect to external registration URL
     ...
     */
    attendGo1(requestParameters, options) {
        return (0, exports.CoursesApiFp)(this.configuration).attendGo1(requestParameters.courseId, requestParameters.source, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Create a global course listing
     ...
     */
    create1(requestParameters, options) {
        return (0, exports.CoursesApiFp)(this.configuration).create1(requestParameters.userId, requestParameters.courseWriteDto, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Get published course by id
     ...
     */
    get1(requestParameters, options) {
        return (0, exports.CoursesApiFp)(this.configuration).get1(requestParameters.courseId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Globally visible active course matched by slug
     * @summary Get published course by URL slug
     ...
     */
    getBySlug1(requestParameters, options) {
        return (0, exports.CoursesApiFp)(this.configuration).getBySlug1(requestParameters.slug, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Globally visible active courses. When createdInLastDays or happeningInNextDays is set, returns the same set as the matching instructor Ortto job (UTC windows); other filters and pagination are ignored for those modes.
     * @summary List published courses
     ...
     */
    list1(requestParameters = {}, options) {
        return (0, exports.CoursesApiFp)(this.configuration).list1(requestParameters.pageFrom, requestParameters.pageTo, requestParameters.language, requestParameters.format, requestParameters.designation, requestParameters.ceCreditsOnly, requestParameters.createdInLastDays, requestParameters.happeningInNextDays, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary List courses owned by user
     ...
     */
    listForUser1(requestParameters, options) {
        return (0, exports.CoursesApiFp)(this.configuration).listForUser1(requestParameters.userId, requestParameters.pageFrom, requestParameters.pageTo, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Record anonymous course interaction (e.g. gated attend)
     ...
     */
    recordAnonymousClick1(requestParameters, options) {
        return (0, exports.CoursesApiFp)(this.configuration).recordAnonymousClick1(requestParameters.courseId, requestParameters.eventType, requestParameters.source, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Update course
     ...
     */
    update1(requestParameters, options) {
        return (0, exports.CoursesApiFp)(this.configuration).update1(requestParameters.courseId, requestParameters.courseWriteDto, options).then((request) => request(this.axios, this.basePath));
    }
}
 ...
 * @export
 */
const GroupNotificationsApiAxiosParamCreator = function (configuration) {
    return {
        /**
         *
         ...
         * @throws {RequiredError}
         */
        getGroupNotifications1: async (userId, groupId, limit, beforeDatetime, options = {}) => {
...
exports.GroupNotificationsApiAxiosParamCreator = GroupNotificationsApiAxiosParamCreator;
/**
 * GroupNotificationsApi - functional programming interface
 * @export
 */
const GroupNotificationsApiFp = function (configuration) {
    const localVarAxiosParamCreator = (0, exports.GroupNotificationsApiAxiosParamCreator)(configuration);
    return {
        /**
         *
         * @summary Get group notification messages for a user and group
         ...
         * @throws {RequiredError}
         */
        async getGroupNotifications1(userId, groupId, limit, beforeDatetime, options) {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['GroupNotificationsApi.getGroupNotifications1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    };
};
exports.GroupNotificationsApiFp = GroupNotificationsApiFp;
/**
 * GroupNotificationsApi - factory interface
 * @export
 */
const GroupNotificationsApiFactory = function (configuration, basePath, axios) {
    const localVarFp = (0, exports.GroupNotificationsApiFp)(configuration);
    return {
        /**
         *
         * @summary Get group notification messages for a user and group
         ...
         * @throws {RequiredError}
         */
        getGroupNotifications1(requestParameters = {}, options) {
...
exports.GroupNotificationsApiFactory = GroupNotificationsApiFactory;
/**
 ...
 * @extends {BaseAPI}
 */
class GroupNotificationsApi extends base_1.BaseAPI {
    /**
     *
     * @summary Get group notification messages for a user and group
     * @param {GroupNotificationsApiGetGroupNotifications1Request} requestParameters Request parameters.
     ...
     */
    getGroupNotifications1(requestParameters = {}, options) {
        return (0, exports.GroupNotificationsApiFp)(this.configuration).getGroupNotifications1(requestParameters.userId, requestParameters.groupId, requestParameters.limit, requestParameters.beforeDatetime, options).then((request) => request(this.axios, this.basePath));
    }
}
exports.GroupNotificationsApi = GroupNotificationsApi;
/**
...
const GroupsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        demoteFromAdmin1: async (groupId, userIds, options = {}) => {
            // verify required parameter 'groupId' is not null or undefined
            (0, common_1.assertParamExists)('demoteFromAdmin1', 'groupId', groupId);
         ...
         * @throws {RequiredError}
         */
        findFederationChildrenBySlug1: async (slug, pageFrom, pageTo, options = {}) => {
            // verify required parameter 'slug' is not null or undefined
            (0, common_1.assertParamExists)('findFederationChildrenBySlug1', 'slug', slug);
         ...
         * @throws {RequiredError}
         */
        listNotifications1: async (groupId, limit, before, options = {}) => {
            // verify required parameter 'groupId' is not null or undefined
            (0, common_1.assertParamExists)('listNotifications1', 'groupId', groupId);
         ...
         * @throws {RequiredError}
         */
        promoteToAdmin1: async (groupId, userIds, options = {}) => {
            // verify required parameter 'groupId' is not null or undefined
            (0, common_1.assertParamExists)('promoteToAdmin1', 'groupId', groupId);
         ...
         * @throws {RequiredError}
         */
        requestGroupTypeChange1: async (id, requestStatus, options = {}) => {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('requestGroupTypeChange1', 'id', id);
         ...
         * @throws {RequiredError}
         */
        searchGroupProperties1: async (groupId, propertyFilterCriteria, options = {}) => {
            // verify required parameter 'groupId' is not null or undefined
            (0, common_1.assertParamExists)('searchGroupProperties1', 'groupId', groupId);
         ...
         * @throws {RequiredError}
         */
        sendNotification1: async (groupId, sendGroupNotificationRequest, options = {}) => {
            // verify required parameter 'groupId' is not null or undefined
            (0, common_1.assertParamExists)('sendNotification1', 'groupId', groupId);
            const localVarPath = `/groups/{groupId}/notifications`
                .replace(`{${"groupId"}}`, encodeURIComponent(String(groupId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
...
const GroupsApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async demoteFromAdmin1(groupId, userIds, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.demoteFromAdmin1(groupId, userIds, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['GroupsApi.demoteFromAdmin1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        async findFederationChildrenBySlug1(slug, pageFrom, pageTo, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.findFederationChildrenBySlug1(slug, pageFrom, pageTo, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['GroupsApi.findFederationChildrenBySlug1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Filter the groups existing in system with specified id. Returns empty if none group match the id and user is not member/owner of it. Includes \'userAdmin\' field indicating whether the current user is an admin or owner of the group.
         ...
         * @throws {RequiredError}
         */
        async listNotifications1(groupId, limit, before, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listNotifications1(groupId, limit, before, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['GroupsApi.listNotifications1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Only group owners can promote members to admin. Can only promote ACCEPTED members.
         ...
         * @throws {RequiredError}
         */
        async promoteToAdmin1(groupId, userIds, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.promoteToAdmin1(groupId, userIds, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['GroupsApi.promoteToAdmin1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Allows group owners to request a change in their group type from GROUP to ASSOCIATION or CERTIFICATION. IMPORTANT: Type changes are only allowed for basic groups (GROUP type). Once a group has been upgraded to ASSOCIATION or CERTIFICATION, no further type changes are possible. Only group owners can make these requests.
         ...
         * @throws {RequiredError}
         */
        async requestGroupTypeChange1(id, requestStatus, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.requestGroupTypeChange1(id, requestStatus, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['GroupsApi.requestGroupTypeChange1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Consider that only user can saveNew its groups
         ...
         * @throws {RequiredError}
         */
        async searchGroupProperties1(groupId, propertyFilterCriteria, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.searchGroupProperties1(groupId, propertyFilterCriteria, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['GroupsApi.searchGroupProperties1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Searches for users within a specific group matching the specified filter criteria
         ...
         * @throws {RequiredError}
         */
        async sendNotification1(groupId, sendGroupNotificationRequest, options) {
...
const GroupsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        demoteFromAdmin1(requestParameters, options) {
         ...
         * @throws {RequiredError}
         */
        findFederationChildrenBySlug1(requestParameters, options) {
         ...
         * @throws {RequiredError}
         */
        listNotifications1(requestParameters, options) {
         ...
         * @throws {RequiredError}
         */
        promoteToAdmin1(requestParameters, options) {
         ...
         * @throws {RequiredError}
         */
        requestGroupTypeChange1(requestParameters, options) {
...
class GroupsApi extends base_1.BaseAPI {
     ...
     */
    demoteFromAdmin1(requestParameters, options) {
        return (0, exports.GroupsApiFp)(this.configuration).demoteFromAdmin1(requestParameters.groupId, requestParameters.userIds, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Return the groups list with specified user id that user has archived
     ...
     */
    findFederationChildrenBySlug1(requestParameters, options) {
        return (0, exports.GroupsApiFp)(this.configuration).findFederationChildrenBySlug1(requestParameters.slug, requestParameters.pageFrom, requestParameters.pageTo, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Filter the groups existing in system with specified id. Returns empty if none group match the id and user is not member/owner of it. Includes \'userAdmin\' field indicating whether the current user is an admin or owner of the group.
     * @summary Return the group with specified id
     ...
     */
    listNotifications1(requestParameters, options) {
        return (0, exports.GroupsApiFp)(this.configuration).listNotifications1(requestParameters.groupId, requestParameters.limit, requestParameters.before, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Only group owners can promote members to admin. Can only promote ACCEPTED members.
     * @summary Promote group members to admin
     ...
     */
    promoteToAdmin1(requestParameters, options) {
        return (0, exports.GroupsApiFp)(this.configuration).promoteToAdmin1(requestParameters.groupId, requestParameters.userIds, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Allows group owners to request a change in their group type from GROUP to ASSOCIATION or CERTIFICATION. IMPORTANT: Type changes are only allowed for basic groups (GROUP type). Once a group has been upgraded to ASSOCIATION or CERTIFICATION, no further type changes are possible. Only group owners can make these requests.
     * @summary Request a change in group type
     ...
     */
    requestGroupTypeChange1(requestParameters, options) {
        return (0, exports.GroupsApiFp)(this.configuration).requestGroupTypeChange1(requestParameters.id, requestParameters.requestStatus, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Consider that only user can saveNew its groups
     * @summary Create or update the group supplied
 ...
 * @export
 */
exports.RequestGroupTypeChange1RequestStatusEnum = {
    None: 'NONE',
    RequestingAssociation: 'REQUESTING_ASSOCIATION',
    RequestingCertification: 'REQUESTING_CERTIFICATION'
};
 ...
 * @export
 */
const HomePreviewApiAxiosParamCreator = function (configuration) {
    return {
        /**
         *
...
exports.HomePreviewApiAxiosParamCreator = HomePreviewApiAxiosParamCreator;
/**
 * HomePreviewApi - functional programming interface
 * @export
 */
const HomePreviewApiFp = function (configuration) {
    const localVarAxiosParamCreator = (0, exports.HomePreviewApiAxiosParamCreator)(configuration);
    return {
        /**
         *
         * @summary Localized marketing home preview HTML
        ...
        async previewHome1(id, lang, acceptLanguage, options) {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['HomePreviewApi.previewHome1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    };
};
exports.HomePreviewApiFp = HomePreviewApiFp;
/**
 * HomePreviewApi - factory interface
 * @export
 */
const HomePreviewApiFactory = function (configuration, basePath, axios) {
    const localVarFp = (0, exports.HomePreviewApiFp)(configuration);
    return {
        /**
         *
         * @summary Localized marketing home preview HTML
...
exports.HomePreviewApiFactory = HomePreviewApiFactory;
/**
 ...
 * @extends {BaseAPI}
 */
class HomePreviewApi extends base_1.BaseAPI {
    /**
     *
     * @summary Localized marketing home preview HTML
     * @param {HomePreviewApiPreviewHome1Request} requestParameters Request parameters.
     ...
     */
    previewHome1(requestParameters = {}, options) {
        return (0, exports.HomePreviewApiFp)(this.configuration).previewHome1(requestParameters.id, requestParameters.lang, requestParameters.acceptLanguage, options).then((request) => request(this.axios, this.basePath));
    }
}
exports.HomePreviewApi = HomePreviewApi;
/**
...
const LocalesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        delete2: async (pnemonic, securityKey, options = {}) => {
            // verify required parameter 'pnemonic' is not null or undefined
            (0, common_1.assertParamExists)('delete2', 'pnemonic', pnemonic);
...
const LocalesApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async delete2(pnemonic, securityKey, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.delete2(pnemonic, securityKey, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['LocalesApi.delete2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Retrieves the complete list of available locales in the system
        ...
        async find1(options) {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['LocalesApi.find1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Retrieves the locale translations in the specified language
...
const LocalesApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        delete2(requestParameters, options) {
...
class LocalesApi extends base_1.BaseAPI {
     ...
     */
    delete2(requestParameters, options) {
        return (0, exports.LocalesApiFp)(this.configuration).delete2(requestParameters.pnemonic, requestParameters.securityKey, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves the complete list of available locales in the system
     * @summary Returns all language list locale entries
     ...
     */
    find1(options) {
        return (0, exports.LocalesApiFp)(this.configuration).find1(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves the locale translations in the specified language
     * @summary Returns locale language list
...
const MessagesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOrttoDynamicContent1: async (type, token, body, options = {}) => {
            // verify required parameter 'type' is not null or undefined
            (0, common_1.assertParamExists)('getOrttoDynamicContent1', 'type', type);
         ...
         * @throws {RequiredError}
         */
        previewOrttoDynamicContent1: async (type, token, options = {}) => {
            // verify required parameter 'type' is not null or undefined
            (0, common_1.assertParamExists)('previewOrttoDynamicContent1', 'type', type);
            const localVarPath = `/notifications/{type}/ortto-dynamic`
                .replace(`{${"type"}}`, encodeURIComponent(String(type)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
...
const MessagesApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getOrttoDynamicContent1(type, token, body, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getOrttoDynamicContent1(type, token, body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['MessagesApi.getOrttoDynamicContent1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        async previewOrttoDynamicContent1(type, token, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.previewOrttoDynamicContent1(type, token, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['MessagesApi.previewOrttoDynamicContent1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         *
...
const MessagesApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getOrttoDynamicContent1(requestParameters, options) {
         ...
         * @throws {RequiredError}
         */
        previewOrttoDynamicContent1(requestParameters, options) {
...
class MessagesApi extends base_1.BaseAPI {
     ...
     */
    getOrttoDynamicContent1(requestParameters, options) {
        return (0, exports.MessagesApiFp)(this.configuration).getOrttoDynamicContent1(requestParameters.type, requestParameters.token, requestParameters.body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @param {MessagesApiPreviewOrttoDynamicContent1Request} requestParameters Request parameters.
     ...
     */
    previewOrttoDynamicContent1(requestParameters, options) {
        return (0, exports.MessagesApiFp)(this.configuration).previewOrttoDynamicContent1(requestParameters.type, requestParameters.token, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Retrieve a user chat
...
const PhonePrefixesApiFp = function (configuration) {
    ...
    return {
        ...
        async get3(options) {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['PhonePrefixesApi.get3']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    };
};
...
class PhonePrefixesApi extends base_1.BaseAPI {
     ...
     */
    get3(options) {
        return (0, exports.PhonePrefixesApiFp)(this.configuration).get3(options).then((request) => request(this.axios, this.basePath));
    }
}
...
const PropertiesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        addPropertyCoBroker1: async (propertyId, addPropertyCoBrokerRequest, options = {}) => {
            // verify required parameter 'propertyId' is not null or undefined
            (0, common_1.assertParamExists)('addPropertyCoBroker1', 'propertyId', propertyId);
            const localVarPath = `/properties/{propertyId}/co-brokers`
                .replace(`{${"propertyId"}}`, encodeURIComponent(String(propertyId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers };
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(addPropertyCoBrokerRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        changePublicationStatus2: async (propertyId, propertyPublicationStateRequest, options = {}) => {
            // verify required parameter 'propertyId' is not null or undefined
            ...
            (0, common_1.assertParamExists)('changePublicationStatus2', 'propertyPublicationStateRequest', propertyPublicationStateRequest);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers };
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(propertyPublicationStateRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        findProperties1: async (propertyFilterCriteria, bypassCache, includeNotAvailableProperties, options = {}) => {
         ...
         * @throws {RequiredError}
         */
        getPropertyCoBrokers1: async (propertyId, options = {}) => {
            // verify required parameter 'propertyId' is not null or undefined
            (0, common_1.assertParamExists)('getPropertyCoBrokers1', 'propertyId', propertyId);
            const localVarPath = `/properties/{propertyId}/co-brokers`
                .replace(`{${"propertyId"}}`, encodeURIComponent(String(propertyId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        translateProperty1: async (propertyId, targetLang, options = {}) => {
            // verify required parameter 'propertyId' is not null or undefined
            (0, common_1.assertParamExists)('translateProperty1', 'propertyId', propertyId);
...
const PropertiesApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async addPropertyCoBroker1(propertyId, addPropertyCoBrokerRequest, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.addPropertyCoBroker1(propertyId, addPropertyCoBrokerRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['PropertiesApi.addPropertyCoBroker1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Re-download fullsize from S3, rotate, overwrite all sizes for each image filename on the property.
         ...
         * @throws {RequiredError}
         */
        async changePublicationStatus2(propertyId, propertyPublicationStateRequest, options) {
         ...
         * @throws {RequiredError}
         */
        async findProperties1(propertyFilterCriteria, bypassCache, includeNotAvailableProperties, options) {
         ...
         * @throws {RequiredError}
         */
        async getPropertyCoBrokers1(propertyId, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPropertyCoBrokers1(propertyId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['PropertiesApi.getPropertyCoBrokers1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Returns recently created properties excluding password-protected and draft properties
         ...
         * @throws {RequiredError}
         */
        async translateProperty1(propertyId, targetLang, options) {
...
const PropertiesApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        addPropertyCoBroker1(requestParameters, options) {
            return localVarFp.addPropertyCoBroker1(requestParameters.propertyId, requestParameters.addPropertyCoBrokerRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Re-download fullsize from S3, rotate, overwrite all sizes for each image filename on the property.
         * @summary Backfill property image orientation
         ...
         * @throws {RequiredError}
         */
        getPropertyCoBrokers1(requestParameters, options) {
            return localVarFp.getPropertyCoBrokers1(requestParameters.propertyId, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns recently created properties excluding password-protected and draft properties
         * @summary Get recently created properties within specified minutes (default 60)
...
class PropertiesApi extends base_1.BaseAPI {
     ...
     */
    addPropertyCoBroker1(requestParameters, options) {
        return (0, exports.PropertiesApiFp)(this.configuration).addPropertyCoBroker1(requestParameters.propertyId, requestParameters.addPropertyCoBrokerRequest, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Re-download fullsize from S3, rotate, overwrite all sizes for each image filename on the property.
     * @summary Backfill property image orientation
     ...
     */
    findProperties1(requestParameters, options) {
        return (0, exports.PropertiesApiFp)(this.configuration).findProperties1(requestParameters.propertyFilterCriteria, requestParameters.bypassCache, requestParameters.includeNotAvailableProperties, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Return the property list with specified user id
     ...
     */
    getPropertyCoBrokers1(requestParameters, options) {
        return (0, exports.PropertiesApiFp)(this.configuration).getPropertyCoBrokers1(requestParameters.propertyId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns recently created properties excluding password-protected and draft properties
     * @summary Get recently created properties within specified minutes (default 60)
...
const PropertyBulkUploadsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        cancelJob1: async (jobId, options = {}) => {
            // verify required parameter 'jobId' is not null or undefined
            (0, common_1.assertParamExists)('cancelJob1', 'jobId', jobId);
         ...
         * @throws {RequiredError}
         */
        createFeedSource1: async (createFeedSourceRequest, options = {}) => {
            const localVarPath = `/property-bulk-uploads/feed-sources`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers };
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(createFeedSourceRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        deleteFeedSource1: async (id, options = {}) => {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('deleteFeedSource1', 'id', id);
            const localVarPath = `/property-bulk-uploads/feed-sources/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        listFeedSources1: async (options = {}) => {
            const localVarPath = `/property-bulk-uploads/feed-sources`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        reconcilePreviewInBody1: async (format, feedSourceId, newFeedSourceName, body, options = {}) => {
            // verify required parameter 'format' is not null or undefined
            (0, common_1.assertParamExists)('reconcilePreviewInBody1', 'format', format);
            const localVarPath = `/property-bulk-uploads/{format}/reconcile-preview/in-body`
            ...
            if (feedSourceId !== undefined) {
                localVarQueryParameter['feedSourceId'] = feedSourceId;
            }
            if (newFeedSourceName !== undefined) {
                localVarQueryParameter['newFeedSourceName'] = newFeedSourceName;
            }
         ...
         * @throws {RequiredError}
         */
        reconcilePreviewInUrl1: async (format, bulkUploadReconcilePreviewUrlRequest, options = {}) => {
            // verify required parameter 'format' is not null or undefined
            (0, common_1.assertParamExists)('reconcilePreviewInUrl1', 'format', format);
            const localVarPath = `/property-bulk-uploads/{format}/reconcile-preview/in-url`
                .replace(`{${"format"}}`, encodeURIComponent(String(format)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers };
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(bulkUploadReconcilePreviewUrlRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        uploadKyeroProperties2: async (feedSourceId, newFeedSourceName, reconcileApproved, body, options = {}) => {
            ...
            if (reconcileApproved !== undefined) {
                localVarQueryParameter['reconcileApproved'] = reconcileApproved;
            }
            localVarHeaderParameter['Content-Type'] = 'application/xml';
            (0, common_1.setSearchParams)(localVarUrlObj, localVarQueryParameter);
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
         ...
         * @throws {RequiredError}
         */
        uploadProperties1: async (format, feedSourceId, newFeedSourceName, reconcileApproved, body, options = {}) => {
            // verify required parameter 'format' is not null or undefined
...
const PropertyBulkUploadsApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async cancelJob1(jobId, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.cancelJob1(jobId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['PropertyBulkUploadsApi.cancelJob1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        async createFeedSource1(createFeedSourceRequest, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createFeedSource1(createFeedSourceRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['PropertyBulkUploadsApi.createFeedSource1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        async deleteFeedSource1(id, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteFeedSource1(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['PropertyBulkUploadsApi.deleteFeedSource1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Get the list of supported file formats for bulk upload
         ...
         * @throws {RequiredError}
         */
        async listFeedSources1(options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listFeedSources1(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['PropertyBulkUploadsApi.listFeedSources1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        async reconcilePreviewInBody1(format, feedSourceId, newFeedSourceName, body, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.reconcilePreviewInBody1(format, feedSourceId, newFeedSourceName, body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['PropertyBulkUploadsApi.reconcilePreviewInBody1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        async reconcilePreviewInUrl1(format, bulkUploadReconcilePreviewUrlRequest, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.reconcilePreviewInUrl1(format, bulkUploadReconcilePreviewUrlRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['PropertyBulkUploadsApi.reconcilePreviewInUrl1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Upload properties using Kyero format with XML content in the request body
         ...
         * @throws {RequiredError}
         */
        async uploadKyeroProperties2(feedSourceId, newFeedSourceName, reconcileApproved, body, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.uploadKyeroProperties2(feedSourceId, newFeedSourceName, reconcileApproved, body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async uploadProperties1(format, feedSourceId, newFeedSourceName, reconcileApproved, body, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.uploadProperties1(format, feedSourceId, newFeedSourceName, reconcileApproved, body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
const PropertyBulkUploadsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        cancelJob1(requestParameters, options) {
         ...
         * @throws {RequiredError}
         */
        createFeedSource1(requestParameters = {}, options) {
            return localVarFp.createFeedSource1(requestParameters.createFeedSourceRequest, options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @summary Delete feed source (does not delete properties)
         ...
         * @throws {RequiredError}
         */
        deleteFeedSource1(requestParameters, options) {
            return localVarFp.deleteFeedSource1(requestParameters.id, options).then((request) => request(axios, basePath));
        },
        /**
         * Get the list of supported file formats for bulk upload
         * @summary Get available formats
         ...
         * @throws {RequiredError}
         */
        listFeedSources1(options) {
            return localVarFp.listFeedSources1(options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @summary Preview listings that would be removed on import
         ...
         * @throws {RequiredError}
         */
        reconcilePreviewInBody1(requestParameters, options) {
            return localVarFp.reconcilePreviewInBody1(requestParameters.format, requestParameters.feedSourceId, requestParameters.newFeedSourceName, requestParameters.body, options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @summary Preview listings that would be removed on URL import
         ...
         * @throws {RequiredError}
         */
        reconcilePreviewInUrl1(requestParameters, options) {
            return localVarFp.reconcilePreviewInUrl1(requestParameters.format, requestParameters.bulkUploadReconcilePreviewUrlRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Upload properties using Kyero format with XML content in the request body
         * @summary Upload Kyero properties with XML in request body
        ...
        uploadKyeroProperties2(requestParameters = {}, options) {
            return localVarFp.uploadKyeroProperties2(requestParameters.feedSourceId, requestParameters.newFeedSourceName, requestParameters.reconcileApproved, requestParameters.body, options).then((request) => request(axios, basePath));
        },
        /**
         * Upload properties in Kyero format by providing a URL to an XML file
         * @summary Upload Kyero properties from URL
        ...
        uploadProperties1(requestParameters, options) {
            return localVarFp.uploadProperties1(requestParameters.format, requestParameters.feedSourceId, requestParameters.newFeedSourceName, requestParameters.reconcileApproved, requestParameters.body, options).then((request) => request(axios, basePath));
        },
        /**
         * Upload properties in the specified format by providing a URL to an XML file
         * @summary Upload properties in specified format from URL
...
class PropertyBulkUploadsApi extends base_1.BaseAPI {
     ...
     */
    cancelJob1(requestParameters, options) {
        return (0, exports.PropertyBulkUploadsApiFp)(this.configuration).cancelJob1(requestParameters.jobId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Create a feed source
     ...
     */
    createFeedSource1(requestParameters = {}, options) {
        return (0, exports.PropertyBulkUploadsApiFp)(this.configuration).createFeedSource1(requestParameters.createFeedSourceRequest, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Delete feed source (does not delete properties)
     ...
     */
    deleteFeedSource1(requestParameters, options) {
        return (0, exports.PropertyBulkUploadsApiFp)(this.configuration).deleteFeedSource1(requestParameters.id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Get the list of supported file formats for bulk upload
     * @summary Get available formats
     ...
     */
    listFeedSources1(options) {
        return (0, exports.PropertyBulkUploadsApiFp)(this.configuration).listFeedSources1(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Preview listings that would be removed on import
     ...
     */
    reconcilePreviewInBody1(requestParameters, options) {
        return (0, exports.PropertyBulkUploadsApiFp)(this.configuration).reconcilePreviewInBody1(requestParameters.format, requestParameters.feedSourceId, requestParameters.newFeedSourceName, requestParameters.body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Preview listings that would be removed on URL import
     ...
     */
    reconcilePreviewInUrl1(requestParameters, options) {
        return (0, exports.PropertyBulkUploadsApiFp)(this.configuration).reconcilePreviewInUrl1(requestParameters.format, requestParameters.bulkUploadReconcilePreviewUrlRequest, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Upload properties using Kyero format with XML content in the request body
     * @summary Upload Kyero properties with XML in request body
     ...
     */
    uploadKyeroProperties2(requestParameters = {}, options) {
        return (0, exports.PropertyBulkUploadsApiFp)(this.configuration).uploadKyeroProperties2(requestParameters.feedSourceId, requestParameters.newFeedSourceName, requestParameters.reconcileApproved, requestParameters.body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Upload properties in Kyero format by providing a URL to an XML file
     * @summary Upload Kyero properties from URL
     ...
     */
    uploadProperties1(requestParameters, options) {
        return (0, exports.PropertyBulkUploadsApiFp)(this.configuration).uploadProperties1(requestParameters.format, requestParameters.feedSourceId, requestParameters.newFeedSourceName, requestParameters.reconcileApproved, requestParameters.body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Upload properties in the specified format by providing a URL to an XML file
     * @summary Upload properties in specified format from URL
...
const SecurityApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        refreshToken1: async (grantType, refreshToken, clientId, clientSecret, options = {}) => {
            // verify required parameter 'grantType' is not null or undefined
            (0, common_1.assertParamExists)('refreshToken1', 'grantType', grantType);
            // verify required parameter 'refreshToken' is not null or undefined
            (0, common_1.assertParamExists)('refreshToken1', 'refreshToken', refreshToken);
            // verify required parameter 'clientId' is not null or undefined
            (0, common_1.assertParamExists)('refreshToken1', 'clientId', clientId);
         ...
         * @throws {RequiredError}
         */
        revokeToken1: async (token, clientId, tokenTypeHint, options = {}) => {
            // verify required parameter 'token' is not null or undefined
            (0, common_1.assertParamExists)('revokeToken1', 'token', token);
            // verify required parameter 'clientId' is not null or undefined
            (0, common_1.assertParamExists)('revokeToken1', 'clientId', clientId);
...
const SecurityApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async refreshToken1(grantType, refreshToken, clientId, clientSecret, options) {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['SecurityApi.refreshToken1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Exchanges the provided authorization code, username, and password for a token through which private application resources can be accessed. Note that the token expires in 15 minutes. When this happens, you must invoke this service again with the previously described parameters.
         ...
         * @throws {RequiredError}
         */
        async revokeToken1(token, clientId, tokenTypeHint, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.revokeToken1(token, clientId, tokenTypeHint, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['SecurityApi.revokeToken1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    };
};
...
const SecurityApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        refreshToken1(requestParameters, options) {
         ...
         * @throws {RequiredError}
         */
        revokeToken1(requestParameters, options) {
...
class SecurityApi extends base_1.BaseAPI {
     ...
     */
    refreshToken1(requestParameters, options) {
        return (0, exports.SecurityApiFp)(this.configuration).refreshToken1(requestParameters.grantType, requestParameters.refreshToken, requestParameters.clientId, requestParameters.clientSecret, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Exchanges the provided authorization code, username, and password for a token through which private application resources can be accessed. Note that the token expires in 15 minutes. When this happens, you must invoke this service again with the previously described parameters.
     * @summary Exchange authorization code for access token
     ...
     */
    revokeToken1(requestParameters, options) {
        return (0, exports.SecurityApiFp)(this.configuration).revokeToken1(requestParameters.token, requestParameters.clientId, requestParameters.tokenTypeHint, options).then((request) => request(this.axios, this.basePath));
    }
}
 ...
 * @export
 */
const StripeIdentityWebhooksApiAxiosParamCreator = function (configuration) {
    return {
        /**
         ...
         * @throws {RequiredError}
         */
        handleVerificationCanceled1: async (stripeEvent, options = {}) => {
         ...
         * @throws {RequiredError}
         */
        handleVerificationRequiresInput1: async (stripeEvent, options = {}) => {
         ...
         * @throws {RequiredError}
         */
        handleVerificationVerified1: async (stripeEvent, options = {}) => {
...
exports.StripeIdentityWebhooksApiAxiosParamCreator = StripeIdentityWebhooksApiAxiosParamCreator;
/**
 * StripeIdentityWebhooksApi - functional programming interface
 * @export
 */
const StripeIdentityWebhooksApiFp = function (configuration) {
    const localVarAxiosParamCreator = (0, exports.StripeIdentityWebhooksApiAxiosParamCreator)(configuration);
    return {
        /**
         * Called by Stripe when identity verification is canceled or marked as invalid
         * @summary Handle verification canceled webhook
         ...
         * @throws {RequiredError}
         */
        async handleVerificationCanceled1(stripeEvent, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.handleVerificationCanceled1(stripeEvent, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['StripeIdentityWebhooksApi.handleVerificationCanceled1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Called by Stripe when verification needs additional review or is flagged
         ...
         * @throws {RequiredError}
         */
        async handleVerificationRequiresInput1(stripeEvent, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.handleVerificationRequiresInput1(stripeEvent, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['StripeIdentityWebhooksApi.handleVerificationRequiresInput1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Called by Stripe when identity verification is successfully completed
         ...
         * @throws {RequiredError}
         */
        async handleVerificationVerified1(stripeEvent, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.handleVerificationVerified1(stripeEvent, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['StripeIdentityWebhooksApi.handleVerificationVerified1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    };
};
exports.StripeIdentityWebhooksApiFp = StripeIdentityWebhooksApiFp;
/**
 * StripeIdentityWebhooksApi - factory interface
 * @export
 */
const StripeIdentityWebhooksApiFactory = function (configuration, basePath, axios) {
    const localVarFp = (0, exports.StripeIdentityWebhooksApiFp)(configuration);
    return {
        /**
         * Called by Stripe when identity verification is canceled or marked as invalid
         * @summary Handle verification canceled webhook
         ...
         * @throws {RequiredError}
         */
        handleVerificationCanceled1(requestParameters = {}, options) {
         ...
         * @throws {RequiredError}
         */
        handleVerificationRequiresInput1(requestParameters = {}, options) {
         ...
         * @throws {RequiredError}
         */
        handleVerificationVerified1(requestParameters = {}, options) {
            return localVarFp.handleVerificationVerified1(requestParameters.stripeEvent, options).then((request) => request(axios, basePath));
        },
    };
};
exports.StripeIdentityWebhooksApiFactory = StripeIdentityWebhooksApiFactory;
/**
 ...
 * @extends {BaseAPI}
 */
class StripeIdentityWebhooksApi extends base_1.BaseAPI {
    /**
     * Called by Stripe when identity verification is canceled or marked as invalid
     * @summary Handle verification canceled webhook
     * @param {StripeIdentityWebhooksApiHandleVerificationCanceled1Request} requestParameters Request parameters.
     ...
     */
    handleVerificationCanceled1(requestParameters = {}, options) {
        return (0, exports.StripeIdentityWebhooksApiFp)(this.configuration).handleVerificationCanceled1(requestParameters.stripeEvent, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Called by Stripe when verification needs additional review or is flagged
     * @summary Handle verification requires input webhook
     ...
     */
    handleVerificationRequiresInput1(requestParameters = {}, options) {
        return (0, exports.StripeIdentityWebhooksApiFp)(this.configuration).handleVerificationRequiresInput1(requestParameters.stripeEvent, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Called by Stripe when identity verification is successfully completed
     * @summary Handle verification verified webhook
     ...
     */
    handleVerificationVerified1(requestParameters = {}, options) {
        return (0, exports.StripeIdentityWebhooksApiFp)(this.configuration).handleVerificationVerified1(requestParameters.stripeEvent, options).then((request) => request(this.axios, this.basePath));
    }
}
exports.StripeIdentityWebhooksApi = StripeIdentityWebhooksApi;
/**
...
const StripeWebhooksApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        postSubscriptionDeleted1: async (stripeEvent, options = {}) => {
         ...
         * @throws {RequiredError}
         */
        postSubscriptionPaused1: async (stripeEvent, options = {}) => {
         ...
         * @throws {RequiredError}
         */
        postTrialWillEnd1: async (stripeEvent, options = {}) => {
...
const StripeWebhooksApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async postSubscriptionDeleted1(stripeEvent, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postSubscriptionDeleted1(stripeEvent, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['StripeWebhooksApi.postSubscriptionDeleted1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        async postSubscriptionPaused1(stripeEvent, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postSubscriptionPaused1(stripeEvent, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['StripeWebhooksApi.postSubscriptionPaused1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        async postTrialWillEnd1(stripeEvent, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postTrialWillEnd1(stripeEvent, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['StripeWebhooksApi.postTrialWillEnd1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         *
...
const StripeWebhooksApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        postSubscriptionDeleted1(requestParameters = {}, options) {
         ...
         * @throws {RequiredError}
         */
        postSubscriptionPaused1(requestParameters = {}, options) {
         ...
         * @throws {RequiredError}
         */
        postTrialWillEnd1(requestParameters = {}, options) {
...
class StripeWebhooksApi extends base_1.BaseAPI {
     ...
     */
    postSubscriptionDeleted1(requestParameters = {}, options) {
        return (0, exports.StripeWebhooksApiFp)(this.configuration).postSubscriptionDeleted1(requestParameters.stripeEvent, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Notify subscription paused
     ...
     */
    postSubscriptionPaused1(requestParameters = {}, options) {
        return (0, exports.StripeWebhooksApiFp)(this.configuration).postSubscriptionPaused1(requestParameters.stripeEvent, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Notify trial will end
     ...
     */
    postTrialWillEnd1(requestParameters = {}, options) {
        return (0, exports.StripeWebhooksApiFp)(this.configuration).postTrialWillEnd1(requestParameters.stripeEvent, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Notify user subscription change
...
const UsersApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        backfillSubscriptionTiers1: async (options = {}) => {
         ...
         * @throws {RequiredError}
         */
        inviteByEmail1: async (origin, userPlatformInviteRequest, options = {}) => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers };
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(userPlatformInviteRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        startUpgradePromo1: async (options = {}) => {
...
const UsersApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async backfillSubscriptionTiers1(options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.backfillSubscriptionTiers1(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['UsersApi.backfillSubscriptionTiers1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Checks the status of a Stripe Identity verification session and marks user as verified if successful
         ...
         * @throws {RequiredError}
         */
        async inviteByEmail1(origin, userPlatformInviteRequest, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.inviteByEmail1(origin, userPlatformInviteRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['UsersApi.inviteByEmail1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        async startUpgradePromo1(options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.startUpgradePromo1(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap['UsersApi.startUpgradePromo1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    };
};
...
const UsersApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        backfillSubscriptionTiers1(options) {
         ...
         * @throws {RequiredError}
         */
        inviteByEmail1(requestParameters = {}, options) {
...
class UsersApi extends base_1.BaseAPI {
     ...
     */
    backfillSubscriptionTiers1(options) {
        return (0, exports.UsersApiFp)(this.configuration).backfillSubscriptionTiers1(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Checks the status of a Stripe Identity verification session and marks user as verified if successful
     * @summary Check identity verification status
     ...
     */
    inviteByEmail1(requestParameters = {}, options) {
        return (0, exports.UsersApiFp)(this.configuration).inviteByEmail1(requestParameters.origin, requestParameters.userPlatformInviteRequest, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Record network suggestion analytics events
     ...
     */
    startUpgradePromo1(options) {
        return (0, exports.UsersApiFp)(this.configuration).startUpgradePromo1(options).then((request) => request(this.axios, this.basePath));
    }
}
